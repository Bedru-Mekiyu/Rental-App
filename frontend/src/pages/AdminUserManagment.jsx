  ...
  return (
    <div className="p-8 bg-[#F8F9FA] min-h-screen">
      <div className="flex justify-between items-end mb-8">
        ...
        <button className="bg-blue-600 text-white px-6 py-2.5 rounded-lg font-bold flex items-center gap-2 hover:bg-blue-700 transition shadow-md">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="p-4 border-b bg-gray-50 flex gap-4">
          <div className="relative flex-1">
            ...
            <input type="text" placeholder="Search users..." className="w-full pl-10 pr-4 py-2 border rounded-lg outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
            ...
            {users.map((user, idx) => (
              <tr key={idx} className="hover:bg-blue-50/30 transition-colors">
                ...
                <td className="p-4 text-center">
                  <button className="text-blue-600 font-bold text-xs hover:underline">Edit Account</button>
                </td>
              </tr>
            ))}
          </tbody>
